...
with tf.Session() as sess:
	...
	for batch in range(300):
		...
		_, l, a, batch_acc, batch_loss = sess.run([minimize_op, loss_summary, accuracy_summary, accuracy, loss], feed_dict={input_images: train_data[idx,...], labels: train_labels[idx]})
		print(l)
